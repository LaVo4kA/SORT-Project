...
from Get_frame_detection import get_detections
...
if __name__ == '__main__':
    ...
    with tensorflow.device('/GPU:0'):
        cap = cv2.VideoCapture('simple.avi')
        ...
        out = cv2.VideoWriter('ssd_out_3.avi', fourcc, 25, (1920, 1080))
        ...
        while True:
            ...
            detections, out_scores = get_detections("yolo-coco", frame)
